...
class EditorialesControllerTest {

    @InjectMocks
    private EditorialesController controller;
    ...
    @Test
    void createEditorialTest() throws Exception {
        String endpoint = base.append("/editorial").toString();
        jsonRequest = new ObjectMapper().writeValueAsString(catalogosRequestModel);
        Mockito.when(service.addNewEditorial(Mockito.any(CatalogosRequestModel.class)))
    ...
    @Test
    void readEditorialTest() throws Exception {
        String endpoint = base.append("/editoriales").toString();
        Mockito.when(service.getAllEditoriales())
    ...
    @Test
    void testReadEditorialTest() throws Exception {
        String endpoint = base.append("/editorial").toString();
        Mockito.when(service.getEditorial(Mockito.anyString()))
    ...
    void updateEditorialTest() throws Exception {
        String endpoint = base.append("/editorial").toString();
        jsonRequest = new ObjectMapper().writeValueAsString(catalogosRequestModel);
        Mockito.when(service.updateEditorial(Mockito.any(CatalogosRequestModel.class)))
                .thenReturn(new CatalogoResponseModel());
    ...
    void deleteEditorialTest() throws Exception {
        String endpoint = base.append("/editorial").toString();
        Mockito.when(service.deleteEditorial(Mockito.anyString()))
                .thenReturn(new GeneralResponseService());
