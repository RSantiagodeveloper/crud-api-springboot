...
@Getter
public class ServiceFlowErrorException extends RuntimeException {
     ...
     * */
    public ServiceFlowErrorException(final String msg) {
        super(msg);
     ...
     * @param msg mensaje de la exception.
     * */
    public ServiceFlowErrorException(final String code, final String msg) {
        super(msg);
        this.code = code;
    }
     ...
     * */
    public ServiceFlowErrorException(final String code, final String msg, final String field) {
